...
a{
    transition:ease-out 350ms!important;
    color: #fff!important;
}
...
<nav class="navbar">
  <div class="container-fluid">
    <a class="navbar-brand" href="index.php">cOnFuSeD??</a>
    <ul class="nav justify-content-center d-none d-sm-flex">
  <li class="nav-item px-4">
    <a class="nav-link px-4" aria-current="page" href="discussions.php">
  ...
  <li class="nav-item px-4">
    <a class="nav-link px-4" href="trending.php">
  ...
  <li class="nav-item px-4">
    <a class="nav-link px-4" href="profiles.php">
...
<div class="row d-flex d-sm-none" style="background-color:#bb00ff">
<div class="col mx-3">
